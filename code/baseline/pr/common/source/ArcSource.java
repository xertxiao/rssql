...
@Public
public class ArcSource extends FromIteratorFunction<Arc> {

    private static final long serialVersionUID = 1L;

    public ArcSource() {
//        super(new RateLimitedIterator<>(ArcIterator.unbounded()));
        super(new RateLimitedIterator<>(ArcIterator.bounded()));
