#ifndef STREAMLOG_PROTOTYPE_PR_EXPERIMENT_H
#define STREAMLOG_PROTOTYPE_PR_EXPERIMENT_H
...
namespace Experiment {
    ...
    class PRExperiment : public Experiment {
    ...
    private:
        ...
        std::string fileSourceName = "/home/ubuntu/Research/Streamlog-prototype/dataset/page_rank_kdd13.data";
...
//                Execution::Element(Execution::E_PLUS, Execution::Tuple{1.0, 3.0}, 1, 1),
//                Execution::Element(Execution::E_PLUS, Execution::Tuple{2.0, 4.0}, 2, 2),
...
//        std::vector<Execution::Element> newEdbBuf;
    ...
    public:
        ...
        PRExperiment(unsigned int w, unsigned int s, bool q);
...
#endif //STREAMLOG_PROTOTYPE_PR_EXPERIMENT_H
