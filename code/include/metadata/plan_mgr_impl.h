#ifndef _STREAMLOG_PROTOTYPE_PLAN_MGR_IMPL_
#define _STREAMLOG_PROTOTYPE_PLAN_MGR_IMPL_
...
#ifndef _PHY_OP_
#include "metadata/phy_op_temp.h"
#endif
...
namespace Metadata {
	...
	public:
		 ...
		 * map method.
		 *
		 * @param     tableId     system-wide mId for the stream/relation
		 *
